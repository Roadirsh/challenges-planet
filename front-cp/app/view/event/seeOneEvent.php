            ...
            <div class="head clearfix">
                ...
                <div class="medium-8 large-9 columns">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="medium-4 columns date-begin"><span>Date from : </span><?php echo $event['event_begin']; ?></div>
                        <div class="medium-4 columns date-finish"><span>Date to : </span><?php echo $event['event_end']; ?></div>
                    </div>
                    ...
                    <?php if(isset($data['done'][0]['group_id']) && !empty($data['done'][0]['group_id']) ){ ?>
                        <div class="team-wrapper columns medium-4">
	                        <div class="wrapper done">
	                            ...
	                            <div class="date"><?php echo $done['group_date']; ?></div>
                        ...
                        foreach ($groups as $key => $g) { ?>
                            <div class="team-wrapper columns medium-4">
                                <div class="wrapper">
                                    ...
                                    <div class="date"><?php echo $g['group_date']; ?></div>
                                    <div class="progressteam">
                                        <div class="clearfix">
