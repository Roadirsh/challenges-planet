        						...
        						<table class="table table-striped table-bordered bootstrap-datatable">
        						  ...
        						  <tbody>
        							...
        							<tr>
        								...
        								<td class="center">
        									<a class="btn btn-info" href="<? echo MODULE . 'user' . ACTION . 'seeoneuser' . ID . $AllUser['user_id']; ?> " >         										<i class="fa fa-pencil-square-o"></i>  
        									</a>
        									<a class="btn btn-danger" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette entrée?'));" href="<? echo MODULE . 'user' . ACTION . 'deluser' . ID . $AllUser['user_id']; ?>">
